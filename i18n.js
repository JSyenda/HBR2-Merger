...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      swapInfoText: 'Arrastra las filas para cambiar el orden.<br>Recorta segundos del inicio o del final de cada rec en formato <b>mm:ss</b>. Útil para quitar tiempo muerto o solapamientos antes de fusionar.',
      mergeBtn: 'Fusionar',
    ...
    en: {
      ...
      swapInfoText: 'Drag the rows to change the order.<br>Trim seconds from the start or the end of each rec using <b>mm:ss</b> format. Useful to cut dead time or overlaps before merging.',
      mergeBtn: 'Merge',
