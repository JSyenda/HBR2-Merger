...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      ksHint: 'Atajos: I intercambiar · M fusionar · A añadir · T tema · R reproducir · N nombre · D descargar',
    ...
    en: {
      ...
      ksHint: 'Shortcuts: I swap · M merge · A add · T theme · R play · N name · D download',
