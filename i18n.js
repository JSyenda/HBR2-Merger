...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      dropHint: 'La primera será la Rec inicial, la segunda la Rec 2 y así hasta la Rec final. Puedes reordenarlas arrastrando las filas o intercambiándolas. También puedes soltarlas en cualquier parte de la página.',
      colPos: 'Posición',
      colFile: 'Archivo',
      colSize: 'Tamaño',
      slot1: 'Rec inicial',
      ...
      pThemeToDark: 'Cambiar a modo oscuro',
      pThemeToLight: 'Cambiar a modo claro',
      pSpeed: 'Velocidad',
      ...
      ksHint: 'Atajos: I intercambiar · M fusionar · A añadir · T tema · R reproducir · N nombre · D descargar · C enlace · O fusiones',
      ...
      ksR: 'R',
      ksPlay: 'Reproducir en el player',
      ksN: 'N',
      ksName: 'Cambiar nombre',
      ksD: 'D',
      ksDownload: 'Descargar',
      ksC: 'C',
      ksCopy: 'Copiar enlace',
      ksO: 'O',
      ksJobs: 'Mis fusiones',
    ...
    en: {
      ...
      dropHint: 'The first one becomes the initial rec, the second Rec 2 and so on up to the final rec. You can reorder them by dragging the rows or swapping them. You can also drop them anywhere on the page.',
      colPos: 'Position',
      colFile: 'File',
      colSize: 'Size',
      slot1: 'Initial rec',
      ...
      pThemeToDark: 'Switch to dark mode',
      pThemeToLight: 'Switch to light mode',
      pSpeed: 'Speed',
      ...
      ksHint: 'Shortcuts: I swap · M merge · A add · T theme · R play · N name · D download · C link · O merges',
