...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      swapInfoText: 'Si la fusión falla o la rec resultante no se reproduce, prueba a intercambiar el orden de las grabaciones: a veces, empezar por la otra rec hace que el fusionador complete el proceso correctamente.<hr>If the merge fails or the resulting rec does not play, try swapping the order of the recordings: sometimes, starting with the other rec makes the merger complete the process correctly.<hr>Arrastra las filas para cambiar el orden.<br>Recorta segundos del inicio o del final de cada rec en formato <b>mm:ss</b>. Útil para quitar tiempo muerto o solapamientos antes de fusionar.',
      mergeBtn: 'Fusionar',
      ...
      pSpeed: 'Velocidad',
      pStepBack: 'Retroceder 1 frame',
      pStepFwd: 'Avanzar 1 frame',
    ...
    en: {
      ...
      swapInfoText: 'Si la fusión falla o la rec resultante no se reproduce, prueba a intercambiar el orden de las grabaciones: a veces, empezar por la otra rec hace que el fusionador complete el proceso correctamente.<hr>If the merge fails or the resulting rec does not play, try swapping the order of the recordings: sometimes, starting with the other rec makes the merger complete the process correctly.<hr>Drag the rows to change the order.<br>Trim seconds from the start or the end of each rec using <b>mm:ss</b> format. Useful to cut dead time or overlaps before merging.',
      mergeBtn: 'Merge',
      ...
      pSpeed: 'Speed',
      pStepBack: 'Back 1 frame',
      pStepFwd: 'Forward 1 frame',
